			...
			<form-group class="border-b gap-8" v-if="hasRoles(['Super Admin', 'Admin'])">
				...
				<div class="col w-full">
					...
					<div class="w-full mt-1">
						<jet-select v-model="form.type" @change="checkLeaves" id="type" class="w-full" track="value" :options="leaveTypes" autocomplete="type" required />
				...
				<div class="col w-full" v-if="form.type == 'individual'">
					...
					<div class="w-full mt-1">
						<jet-select v-model="form.userId" @change="checkLeaves" id="userId" class="w-full" :options="users" autocomplete="userId" required />
